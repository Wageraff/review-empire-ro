...
- Ai deja un [value betting](/ghiduri/strategii/ce-este-value-betting) clar, cu valoare calculată peste 1,00
- Estimarea probabilității vine din analiză solidă (statistici, formă, absențe), nu din intuiție
- Ai un [bankroll](/ghiduri/gestionarea-banilor/bankroll-management) stabil, separat de cheltuielile zilnice
- Ai evidență pe termen lung, pe cel puțin câteva sute de pariuri

Kelly nu are sens la pariuri impulsive, la [live betting](/ghiduri/notiuni-de-baza/ce-sunt-pariurile-live) fără plan sau când probabilitatea e „simțită", nu calculată.
...
- **Combini cu Martingale** — dublarea mizei după pierderi contrazice logica Kelly, care se bazează pe edge, nu pe recuperare ([martingale](/ghiduri/strategii/strategia-martingale-la-pariuri))
- **Nu folosești varianta fracționară** — Quarter-Kelly sau Half-Kelly sunt standardul în comunitatea de pariori serioși

## Concluzie

Criteriul Kelly transformă dimensionarea mizei dintr-o alegere arbitrară într-un calcul precis, ancorat în edge-ul real identificat prin [value betting](/ghiduri/strategii/ce-este-value-betting). Aplicat corect — de preferință fracționar — reduce mult riscul unui declin brusc al bankroll-ului, fără să elimine variance-ul inerent pariurilor. Rămâne, totuși, o unealtă pentru pariori cu experiență și evidență documentată, nu o scurtătură pentru cineva la început de drum.
